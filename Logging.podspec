#
#  Be sure to run `pod spec lint Logging.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Le Ngoc Duy" => "askbills@gmail.com" }
  spec.social_media_url   = "https://twitter.com/askbills"
  ...
  spec.source_files  = "Logging", "Logging/**/*.{h,m,swift}"
  spec.exclude_files = "Logging/Exclude"

  spec.public_header_files = "Logging/**/*.h"
